    ...
    <div class="grid-container">
      ...
      <div class="col-span-6 md:col-span-10">
        <dl class="md:grid grid-cols-10 mt-2 md:mt-12 gap-x-5 gap-y-10">
          ...
          <dd>This dashboard defines nonoperational violations as those MVC violations that are not the result of the manner of operating the vehicle. Examples include window tint, a broken tail light, or expired inspection or registration.</dd>
          <dt>Operational</dt>
          <dd>This dashboard defines operational violations as those MVC violations that occur based on the manner in which a vehicle is operated. Examples include failure to obey a traffic signal, illegal passing of another vehicle, or speeding.</dd>
          <dt>PPD</dt>
