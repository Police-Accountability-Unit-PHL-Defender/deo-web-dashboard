  ...
  <p>To comply with the <a
    ...
    publicly, including personally identifiable information and information about the officers who made each stop.</p>
          ...
          <FaqQuestion id="12" question="Was the traffic stop data cleaned before analysis?">
            ...
            <p>Furthermore, on May 1, 2024, the PPD consolidated two districts, expanding District 9 to include what used to be District 6. To reflect these new borders and create consistency, this dashboard has remapped traffic stops previously belonging to District 6 to reflect the new District 9 borders and PSAs. Unfortunately, the OpenDataPhilly location data is not completely reliable. Therefore, in this dashboard, the total number of traffic stops in District 9 does not match the sum of the number of traffic stops across the PSAs in District 9, as 16% of the District 9 traffic stops were erroneously geocoded to a null location or to a single location in Erie, PA (42.2243359, -80.50237161).</p>
          </FaqQuestion>
