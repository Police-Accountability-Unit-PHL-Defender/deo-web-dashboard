...
A second common-sample comparison fits three binary outcomes over those same
rows: Black rather than white non-Latino, age 18–29 rather than 30+, and male
rather than female. Their average marginal darkness effects share one
percentage-point scale, so the page can compare the magnitude of the race,
age, and gender composition shifts. This is an effect-size ranking, not a
variance decomposition or a claim that one identity characteristic explains
