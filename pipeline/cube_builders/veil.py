    ...
    for year in TREND_YEARS:
        ...
        for outcome in TREND_OUTCOMES:
            ...
            estimates.append({
                ...
                "marginal_daylight_se_pp": result["marginal_daylight_se_pp"],
                "marginal_dark_se_pp": result["marginal_dark_se_pp"],
                "marginal_daylight_ci_lo_pct": result["marginal_daylight_ci_lo_pct"],
                "marginal_daylight_ci_hi_pct": result["marginal_daylight_ci_hi_pct"],
                "marginal_dark_ci_lo_pct": result["marginal_dark_ci_lo_pct"],
                "marginal_dark_ci_hi_pct": result["marginal_dark_ci_hi_pct"],
